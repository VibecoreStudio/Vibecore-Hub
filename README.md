...
> **顶部功能图标右键：打开该功能设置。**
>
> **快捷图标、便笺、目录和音频预设右键：编辑、删除或查看更多操作。**
>
> 记住右键，基本就掌握了 Vibecore Hub。

- 拖动左上角 Vibecore 图标区域移动窗口；右键该区域打开全局设置
- 拖动窗口左右边缘调整宽度；拖动模块底部的 `···` 调整模块高度
- 将程序、文件、文件夹或快捷方式直接拖进快捷方式库，即可自动添加
- 拖动快捷图标、便笺或目录卡片调整顺序，亮色插入线表示目标位置
- 右上角图钉控制窗口置顶；`×` 将程序隐藏到系统托盘

完整操作请查看：[Vibecore Hub 使用指南](docs/USER_GUIDE.md)

## 国际化计划

当前 v1.2.1 软件界面为简体中文。**下一版本将加入软件内语言菜单，支持简体中文、English 和日本語一键切换。**
